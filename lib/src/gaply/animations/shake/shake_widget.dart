...
class GaplyShakeWidget extends StatefulWidget {
  final Widget child;
  final GaplyShake style;

  const GaplyShakeWidget({super.key, required this.child, required this.style});

  @override
  State<GaplyShakeWidget> createState() => GaplyShakeWidgetState();
}

class GaplyShakeWidgetState extends State<GaplyShakeWidget> with SingleTickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(GaplyShakeWidget oldWidget) {
  ...
  void executeParams(GaplyShake style) {
