...
class GaplySkewWidget extends StatefulWidget {
  final Widget child;
  final GaplySkew style;

  const GaplySkewWidget({super.key, required this.child, required this.style});

  @override
  State<GaplySkewWidget> createState() => GaplySkewWidgetState();
}

class GaplySkewWidgetState extends State<GaplySkewWidget> with SingleTickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(covariant GaplySkewWidget oldWidget) {
  ...
  void executeParams(GaplySkew style) {
