...
class GaplyTrainWidget<T> extends StatefulWidget {
  final T currentItem;
  final T? previousItem;
  final Widget Function(T item) itemBuilder;
  final GaplyTrain style;

  const GaplyTrainWidget({
    super.key,
  ...
  @override
  State<GaplyTrainWidget<T>> createState() => GaplyTrainWidgetState<T>();
}

class GaplyTrainWidgetState<T> extends State<GaplyTrainWidget<T>> with SingleTickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(GaplyTrainWidget<T> oldWidget) {
  ...
  void executeParams(GaplyTrain style) {
